...
write_xlsx(Sa_ProvincialCOVID19,"Sa_ProvincialCOVID19.xlsx")
...
There appears to be an error in the Daily_Deaths,Daily_Cases and
...
The daily cases are skewed to the left as shown in the descriptive
...
The daily deaths are skewed to the left as shown in the descriptive
stats, histogram, density plot and boxplot. There appears to be outliers
as shown by the boxplot but these values are extreme values which
...
<1>4.Data Visualization using Tableau</h1>
<h2>(i)Total confirmed cases and deaths over time dashboard:</h2>
https://public.tableau.com/app/profile/mufaro.chinake/viz/SouthAfricaCOVID19ConfirmedCases/Dashboard1?publish=yes

<h2>(ii) Daily cases and deaths over time</h2>
https://public.tableau.com/app/profile/mufaro.chinake/viz/SouthAfricaCOVID19DailyCasesandDeaths/Dashboard1?publish=yes
